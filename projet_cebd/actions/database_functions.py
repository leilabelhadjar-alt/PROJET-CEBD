...
def database_create(data):
    ...
    try:
        ...
        db.updateDBfile(data, "/home/o/oumezias/L3_infG/projet_cebd/base_donnee.sql")
        db.updateDBfile(data, "/home/o/oumezias/L3_infG/projet_cebd/View.sql")
        db.updateDBfile(data, "/home/o/oumezias/L3_infG/projet_cebd/Trigers.sql")
...
def database_insert(data):
    ...
    try:
        # LECTURE ET INSERTION DU FICHIER EXCEL (version V0)
...
def database_delete(data):
    ...
    try:
        ...
        db.updateDBfile(data, "data/v0_deleteDB.sql") # ajouter les drop dans le chemin <<<<<<THANINA
    except Exception as e:
        # En cas d'erreur, on affiche un message
